...
* From your web browser, use something like this as the URL: "http://localhost/rwr?gpx=on&filename=Behunin_Canyon&url=http://ropewiki.com/images/c/cb/Behunin_Canyon.kml" or test a KML/GPX download link from RopeWiki.com itself.
...
Other commands have not been attempted yet. We hava not tried to run the 'httprobot' executable.
